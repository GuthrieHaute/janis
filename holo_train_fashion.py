...
def train():
    ...
    print(f"HOLOGRAPHIC FASHION TRAINING - Device: {device}")

    train_loader, test_loader, num_classes, img_size = get_dataloader('fashion', args.batch_size)
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            plt.imsave(f"samples/fashion_epoch_{epoch+1:02d}.png", grid.permute(1, 2, 0).cpu().numpy())

    torch.save(model.state_dict(), f"checkpoints/holo_fashion_final.pth")
